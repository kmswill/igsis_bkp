...
$sqlparcela = "SELECT * from igsis_parcelas WHERE idPedido = '$id_ped' AND numero = '$parcela' LIMIT 0,1";
$queryparcela = mysqli_query ($conexao,$sqlparcela);
$parc = mysqli_fetch_array ($queryparcela);


$id = $pedido['idEvento'];
$Objeto = $pedido["Objeto"];
$Periodo = "entre ".exibirDataBr($parc['vigencia_inicio'])." a ".exibirDataBr($parc['vigencia_final']);
$Duracao = $pedido["Duracao"];
$CargaHoraria = $pedido["CargaHoraria"];
$Local = $pedido["Local"];
$Local = $pedido["Local"];
$ValorGlobal = dinheiroParaBr($parc["valor"]);
$ValorPorExtenso = valorPorExtenso($parc["valor"]);
